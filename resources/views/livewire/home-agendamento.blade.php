    ...
    <div class="mt-16">
        @if($passoAtual === 1)
            <div class="flex flex-col w-full mx-auto max-w-sm justify-center p-6 border border-gray-300 rounded-2xl">
                ...
                <form class="mt-5 space-y-6" wire:submit="avancarPassoDois">
        ...
        @if($passoAtual === 2)
                <div class="flex flex-col w-full mx-auto max-w-sm justify-center p-6 border border-gray-300 rounded-2xl">
                    ...
                    <form class="mt-5 space-y-6" wire:submit="avancarPassoTres">
                        <fieldset>
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input wire:model="corte" value="true" id="comments" aria-describedby="comments-description" name="comments" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    </div>
                                ...
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input wire:model="barba" id="candidates" value="true" aria-describedby="candidates-description" name="candidates" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    </div>
                                    <div class="ml-3 text-sm leading-6">
                                ...
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input wire:model="sobrancelha" id="offers" value="true" aria-describedby="offers-description" name="offers" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    </div>
                                    <div class="ml-3 text-sm leading-6">
